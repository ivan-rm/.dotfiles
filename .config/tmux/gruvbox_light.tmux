...
set-window-option -g window-status-current-format "#[fg=#ebdbb2,bg=#689d6a,nobold,noitalics,nounderscore]#[fg=#3c3836,bg=#689d6a] #I #[fg=#3c3836,bg=#689d6a,bold] #W#{?window_zoomed_flag,*Z,} #[fg=#689d6a,bg=#ebdbb2,nobold,noitalics,nounderscore]"
