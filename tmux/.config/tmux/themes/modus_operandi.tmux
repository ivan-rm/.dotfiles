...
set-option -g status-left '#[bg=#c8c8c8,fg=#0a0a0a,bold]#{?client_prefix,,  tmux  }#[bg=#3548cf,fg=#f2f2f2,bold]#{?client_prefix,  tmux  ,}#[bg=#c8c8c8,fg=#0a0a0a] '
set-option -g status-right '#[bg=#c8c8c8,fg=#0a0a0a,bold]S[#S] '
